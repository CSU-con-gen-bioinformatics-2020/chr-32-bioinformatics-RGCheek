...
rclone copy --tpslimit 10 --fast-list -P --drive-shared-with-me RGCheek:CSU-con-gen-2020/pre-indexed-chinook-genome  pre-indexed-chinook-genome
...
rclone copy --tpslimit 10 --fast-list -P --drive-shared-with-me RGCheek:CSU-con-gen-2020/fastqs-chr32-160-chinook-8-lanes  fastqs-chr32-160-chinook-8-lanes
...
ln -s /scratch/summit/rgcheek@colostate.edu/chr-32-bioinformatics/chr-32-bioinformatics-RGCheek genome
